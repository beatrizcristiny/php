...
AULA-4
ex1- A sessão é a forma do sistema de lembrar quem é o usuario tipo no inicio o usuario recebe um codigo e com esse coddigo o sistema vai lembrando e sabe quem está logado. Sem a sessão o sistema esquece quem é o usuario.
